...
"
"   " According to the language specification it is not garanteed to stay in
"   the
...
"   contains=@Spell,goTodo
"
"   " Numerals
"   syn case ignore
"   "integer number, or floating point number without a dot and with "f".
"   syn match       goNumbers        display transparent "\<\d\|\.\d"
"   contains=goNumber,goFloat,goOctError,goOct
"   syn match       goNumbersCom     display contained transparent
"   "\<\d\|\.\d" contains=goNumber,goFloat,goOct
"   syn match       goNumber         display contained
"   "\d\+\(u\=l\{0,2}\|ll\=u\)\>"
"
"   " hex number
"   syn match       goNumber         display contained
...
"
"   " oct number
"   syn match       goOct            display contained
"   "0\o\+\(u\=l\{0,2}\|ll\=u\)\>" contains=goOctZero
"   syn match       goOctZero        display contained "\<0"
"
"   syn match       goFloat          display contained
"   "\d\+\.\d*\(e[-+]\=\d\+\)\="
"   syn match       goFloat          display contained "\d\+e[-+]\=\d\=\>"
"   syn match       goFloat          display
"   "\(\.[0-9_]\+\)\(e[-+]\=[0-9_]\+\)\=[fl]\=i\=\>"
"
"   " Literals
"   syn region      goString         start=+L\="+ skip=+\\\\\|\\"+ end=+"+
"   contains=@Spell
"
"   syn match       goSpecial        display contained
"   "\\\(x\x\+\|\o\{1,3}\|.\|$\)"
